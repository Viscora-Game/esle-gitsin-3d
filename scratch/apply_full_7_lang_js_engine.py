...
# Expanded 7-Language Dictionary containing ALL UI strings, titles, tutorial slides, and labels
new_i18n_dict = """        // Complete 7-Language Global Localization Engine (TR, EN, DE, FR, IT, ES, PT)
        this.i18n = {
            tr: {
...
# Match where this.i18n starts and ends in game.js
pattern = r"// Full 7-Language i18n Translations Dictionary.*?^        };"
match = re.search(pattern, js_content, re.MULTILINE | re.DOTALL)
if match:
    js_content = js_content.replace(match.group(0), new_i18n_dict.strip())
    print('Replaced this.i18n dictionary with full 7-language global coverage!')
else:
    print('Pattern not matched! Checking alternatives...')
