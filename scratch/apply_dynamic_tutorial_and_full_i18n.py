...
# Replace tutorial slides logic in game.js with getTutorialSlides() method
old_tut_slide_method = """    renderTutorialSlide() {
...
new_tut_slide_method = """    getTutorialSlides() {
...
if old_tut_slide_method in js_content:
    js_content = js_content.replace(old_tut_slide_method, new_tut_slide_method)
    print('Updated renderTutorialSlide and added getTutorialSlides!')

# Replace applyLanguage method to trigger real-time updates across all screens
old_apply_lang = """    applyLanguage() {
...
if old_apply_lang in js_content:
    js_content = js_content.replace(old_apply_lang, new_apply_lang)
    print('Updated applyLanguage method for complete real-time global translation!')
