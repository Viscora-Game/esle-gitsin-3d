...
Download now and join the matching fun!"""
    },
    {
        ...
        "Full description": """¡Prepárate para una divertida aventura 3D de emparejamiento con Match & Go! 3D!
...
desktop_dir = r"c:\Users\Acer\OneDrive\Masaüstü"
project_dir = r"c:\Users\Acer\OneDrive\Masaüstü\Eşleme Oyunu"

for target_dir in [desktop_dir, project_dir]:
    csv_path = os.path.join(target_dir, "play_store_translations.csv")
...
print("Successfully generated play_store_translations.csv with exact language codes de-DE, fr-FR, pt-BR, en-US, es-ES, tr-TR!")
