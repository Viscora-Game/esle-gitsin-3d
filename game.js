...
class TileMatchingGame {
    ...
    constructor() {
        ...
        this.i18n = {
            tr: {
                ...
                wheelLimitReached: "Bugünkü Çark Haklarınız Bitti! (2/2 - Yarın Tekrar Gel )",
                ...
                adFullTag: "DOLDU",
                adChestLimitReached: "Bugünkü Ücretsiz Reklam Sandığı Hakkınız Bitti! (0/3 - Yarın Tekrar Gel )",
                adReviveLimitReached: "Bu Bölümdeki Reklamla Devam Etme Hakkınız Bitti! (2/2)",
                ...
                timetrialBtnText: "⏱ ZAMANA KARŞI MOD (SEVİYE {lvl})",
                ...
                vibOn: "AÇIK",
                vibOff: "KAPALI",
                noUndoTiles: "↩ Tepside geri alınacak kart bulunmuyor!",
                noScoreUndo: "Yetersiz Skor! ({cost} Puan Gerekli)",
                undoSuccessMsg: "↩ 1 Kart Tahtaya Geri Alındı!",
                ...
                forceUpdateBtn: "CANLI GÜNCELLEMEYİ YÜKLE (v8.9.90)",
                ...
                resetTimeTrialBtn: "⏱ ZAMANA KARŞI MODU SIFIRLA",
                ...
                insufficientGold: "Yetersiz Altın! (100 Altın Gerekli )",
            ...
            en: {
                ...
                wheelLimitReached: "Daily Wheel Limit Reached! (2/2 - Come Back Tomorrow )",
                ...
                adFullTag: "FULL",
                adChestLimitReached: "Daily Free Ad Chest Limit Reached! (0/3 - Come Back Tomorrow )",
                adReviveLimitReached: "Max Level Revives Reached! (2/2)",
                ...
                timetrialBtnText: "⏱ TIME TRIAL MODE (LEVEL {lvl})",
                ...
                vibOn: "ON",
                vibOff: "OFF",
                noUndoTiles: "↩ No tiles in tray to undo!",
                noScoreUndo: "Insufficient Score! ({cost} Points Needed)",
                undoSuccessMsg: "↩ 1 Tile Returned to Board!",
                ...
                insufficientGold: "Not Enough Gold! (100 Gold Needed )",
            ...
            de: {
                ...
                wheelLimitReached: "Tägliches Rad-Limit erreicht! (2/2 - Morgen wiederkommen )",
                ...
                adFullTag: "VOLL",
                adChestLimitReached: "Tägliches Gratis-Truhen-Limit erreicht! (0/3 - Morgen wiederkommen )",
                adReviveLimitReached: "Max. Reaktivierungen in diesem Level erreicht! (2/2)",
                ...
                timetrialBtnText: "⏱ ZEITRENNEN (LEVEL {lvl})",
                ...
                vibOn: "AN",
                vibOff: "AUS",
                noUndoTiles: "↩ Keine Karten in der Leiste zum Rückgängigmachen!",
                noScoreUndo: "Unzureichende Punktzahl! ({cost} Punkte erforderlich)",
                undoSuccessMsg: "↩ 1 Karte auf das Spielfeld zurückgelegt!",
                ...
                forceUpdateBtn: "LIVE-UPDATE INSTALLIEREN (v8.9.90)",
                ...
                resetTimeTrialBtn: "⏱ ZEITRENNEN ZURÜCKSETZEN",
                ...
                insufficientGold: "Nicht genug Gold! (100 Gold benötigt )",
            ...
            fr: {
                ...
                wheelLimitReached: "Limite quotidienne de la roue atteinte! (2/2 - Revenez demain )",
                ...
                adFullTag: "PLEIN",
                adChestLimitReached: "Limite quotidienne de coffres gratuits atteinte! (0/3 - Revenez demain )",
                adReviveLimitReached: "Limite de réanimations par niveau atteinte! (2/2)",
                ...
                timetrialBtnText: "⏱ CONTRE-LA-MONTRE (NIVEAU {lvl})",
                ...
                vibOn: "ACTIVÉ",
                vibOff: "DÉSACTIVÉ",
                noUndoTiles: "↩ Aucune carte sur le plateau à annuler !",
                noScoreUndo: "Score insuffisant ! ({cost} points nécessaires)",
                undoSuccessMsg: "↩ 1 carte retournée sur le plateau !",
                ...
                forceUpdateBtn: "INSTALLER MISE À JOUR (v8.9.90)",
                ...
                resetTimeTrialBtn: "⏱ RÉINIT. CONTRE-LA-MONTRE",
                ...
                nextBtn: "SUIVANT",
                pageIndicator: "Page {current} / {total}",
                insufficientGold: "Or insuffisant! (100 Or requis )",
            ...
            it: {
                ...
                wheelLimitReached: "Limite giornaliero ruota raggiunto! (2/2 - Torna domani )",
                ...
                adFullTag: "PIENO",
                adChestLimitReached: "Limite giornaliero bauli gratis raggiunto! (0/3 - Torna domani )",
                adReviveLimitReached: "Limite di riattivazioni per livello raggiunto! (2/2)",
                ...
                timetrialBtnText: "⏱ CRONOMETRO (LIVELLO {lvl})",
                ...
                vibOn: "ATTIVO",
                vibOff: "DISATTIVO",
                noUndoTiles: "↩ Nessuna tessera nel vassoio da annullare!",
                noScoreUndo: "Punteggio insufficiente! (Servono {cost} punti)",
                undoSuccessMsg: "↩ 1 tessera riportata sul tabellone!",
                ...
                insufficientGold: "Oro insufficiente! (100 Oro richiesti )",
            ...
            es: {
                ...
                wheelLimitReached: "¡Límite diario de la rueda alcanzado! (2/2 - Vuelve mañana )",
                ...
                adFullTag: "LLENO",
                adChestLimitReached: "¡Límite diario de cofres gratis alcanzado! (0/3 - Vuelve mañana )",
                adReviveLimitReached: "¡Máximo de reanimaciones por nivel alcanzado! (2/2)",
                ...
                timetrialBtnText: "⏱ MODO CONTRARELOJ (NIVEL {lvl})",
                ...
                vibOn: "ACTIVADO",
                vibOff: "DESACTIVADO",
                noUndoTiles: "↩ ¡No hay cartas en la bandeja para deshacer!",
                noScoreUndo: "¡Puntuación insuficiente! (Se necesitan {cost} puntos)",
                undoSuccessMsg: "↩ ¡1 carta devuelta al tablero!",
                ...
                forceUpdateBtn: "INSTALAR ACTUALIZACIÓN (v8.9.90)",
                ...
                resetTimeTrialBtn: "⏱ REINICIAR CONTRARELOJ",
                ...
                insufficientGold: "¡Oro insuficiente! (100 Oro requeridos )",
            ...
            pt: {
                ...
                wheelLimitReached: "Limite diário da roleta atingido! (2/2 - Volte amanhã )",
                ...
                adFullTag: "CHEIO",
                adChestLimitReached: "Limite diário de baús grátis atingido! (0/3 - Volte amanhã )",
                adReviveLimitReached: "Limite de reanimações na fase atingido! (2/2)",
                ...
                timetrialBtnText: "⏱ CONTRA O TEMPO (NÍVEL {lvl})",
                ...
                vibOn: "LIGADO",
                vibOff: "DESLIGADO",
                noUndoTiles: "↩ Nenhuma carta na bandeja para desfazer!",
                noScoreUndo: "Pontuação insuficiente! (Necessários {cost} pontos)",
                undoSuccessMsg: "↩ 1 carta retornada ao tabuleiro!",
                ...
                forceUpdateBtn: "INSTALAR ATUALIZAÇÃO (v8.9.90)",
                ...
                resetTimeTrialBtn: "⏱ REINICIAR CONTRA O TEMPO",
                ...
                nextBtn: "PRÓXIMO",
                pageIndicator: "Página {current} / {total}",
                insufficientGold: "Ouro insuficiente! (100 Ouro necessários )",
        ...
        try {
            ...
            if (this.level && this.level >= 1) {
                ...
                if (this.currentMode === 'classic') {
                    ...
                    const prevScore = (this.classicProgress && typeof this.classicProgress.score === 'number') ? this.classicProgress.score : 0;
                    const currentScore = (typeof this.score === 'number') ? this.score : 0;
                    
                    let safeScore;
                    if (allowDecrease) {
                        safeScore = Math.max(baseMinScore, Math.max(0, currentScore));
                    } else {
                        safeScore = Math.max(prevScore, currentScore, baseMinScore);
                    }
                    ...
                    const prevScore = (this.timeTrialProgress && typeof this.timeTrialProgress.score === 'number') ? this.timeTrialProgress.score : 0;
                    const currentScore = (typeof this.score === 'number') ? this.score : 0;
    ...
    initUI() {
        ...
        if (btnAdChest) {
            btnAdChest.addEventListener('click', () => {
                ...
                this.showRewardedAd(() => {
                    ...
                    this.showToast('Reklam Ödülü: Sandık açılıyor...');
        ...
        if (btnAdRevive) {
            btnAdRevive.addEventListener('click', () => {
                if (this.levelAdReviveCount >= 1) {
                    ...
                    const dict = this.i18n[this.settings.lang] || this.i18n.tr;
                    this.showToast(dict.adReviveLimitReached || 'Bu bölümdeki reklam hakkınız doldu (1/1)');
                    return;
                }
                ...
                this.showRewardedAd(() => {
                    ...
                    const dict = this.i18n[this.settings.lang] || this.i18n.tr;
                    this.showToast(`${dict.reviveUsedToast || 'Canlı Hak Kullanıldı! 2 Kart Tahtaya Döndü'} (1/1)`);
        ...
        if (btnAcceptQuitPenalty) {
            btnAcceptQuitPenalty.addEventListener('click', () => {
                ...
                this.saveGameProgress(false, true);
                this.syncCloudLeaderboard();
                ...
                this.showToast('Bölümden ayrıldınız (-500 Puan Cezası kesildi)');
        ...
        if (btnSpinAdAccept) {
            btnSpinAdAccept.addEventListener('click', () => {
                ...
                if (!navigator.onLine) {
                    this.sound.playLockThud();
                    this.showToast('Çevrimdışı Mod: Reklam için internet bağlantısı gerekiyor');
                    return;
                }
    ...
    updateLockStates() {
        // STRICT MAHJONG LAYER-BY-LAYER CARD UNLOCKING RULE:
        // A card is UNLOCKED & CLICKABLE only when no upper card is significantly covering it!
    ...
    useUndoBooster() {
        ...
        if (!this.slotTiles || this.slotTiles.length === 0) {
            ...
            this.showToast(dict.noUndoTiles || 'Tepside geri alınacak kart bulunmuyor!');
            return;
        }
        ...
        this.showToast(dict.undoSuccessMsg || '1 Kart Tahtaya Geri Alındı');
    }
    ...
    useExtraSlotBooster() {
        ...
        if (this.hasTemporaryExtraSlot || this.maxSlotCapacity > 5) {
            this.sound.playLockThud();
            this.triggerVibration();
            this.showToast(dict.slotAlreadyActiveToast || 'Ekstra Slot zaten aktif! Kullanılıp kapandığında tekrar alabilirsiniz.');
            return;
        }
    ...
    checkDeadlockAndAutoShuffle() {
        ...
        this.showToast('Hamle kalmadı! Tahta karıştırılıyor...');
        this.sound.playBoosterChime();
        const boardEl = document.getElementById('board');
        if (boardEl) {
            const rect = boardEl.getBoundingClientRect();
    ...
    processPairMatch(tileA, tileB) {
        ...
        this.pairMatchTimeout = setTimeout(() => {
            ...
            if (this.hasTemporaryExtraSlot && this.extraSlotWasUsed) {
                ...
                const dict = (this.i18n && this.i18n[this.settings.lang]) ? this.i18n[this.settings.lang] : (this.i18n ? this.i18n.tr : {});
                this.showToast(dict.slotUsedClosedToast || 'Acil slot hakkı kullanıldı ve kapandı.');
                this.updateBoosterBadgesUI();
            }
    ...
    buyPuzzlePieceWithGold() {
        ...
        if (!added) {
            this.showToast('Tüm bulmaca parçaları toplandı!');
            return;
        }
    ...
    handlePlacePuzzlePiece(invId, puzzleId, pieceIndex, targetSlotIndex) {
        ...
        if (this.placedPuzzlePieces[puzzleId].length === 12) {
            this.sound.playVictorySound();
            this.fx.spawnConfetti();
            this.showToast(`Tebrikler! ${this.activePuzzleId.toUpperCase()} yapbozu tamamlandı!`);
        }
    ...
    showRewardedAd(onSuccess, onFailure) {
        ...
        if (typeof navigator !== 'undefined' && navigator.onLine === false && !window.AndroidAdMob) {
            this.sound.playLockThud();
            const dict = (this.i18n && this.i18n[this.settings.lang]) ? this.i18n[this.settings.lang] : (this.i18n ? this.i18n.tr : {});
            this.showToast(dict.offlineAdMsg || 'Çevrimdışı Mod: Reklam için internet bağlantısı gerekiyor');
    ...
    async fetchCloudLeaderboardData() {
        // High-speed multi-stage cloud fetch with 0ms fallback:
        // 1. Live Render MongoDB Atlas Backend (/api/debug_users) - Instant ~200ms response!
        // 2. Dedicated endpoint fallback (/api/esle-gitsin/leaderboard)
        // 3. Global GitHub Raw CDN (leaderboard.json)
        // 4. In-memory local cache & seed champions

        // 1. Live MongoDB Atlas endpoint via Render
        try {
            const resp = await this.fetchWithTimeout('https://viscora.onrender.com/api/debug_users?t=' + Date.now(), {
                cache: 'no-store',
                headers: {
                ...
                if (Array.isArray(debugUsers) && debugUsers.length > 0) {
                    ...
                    for (const u of debugUsers) {
                        ...
                        const tag = parts[1] || '0001';
                            ...
                            const tt = Number(avatarParts[0]) || Math.max(0, overall - classic);
                    ...
                    if (parsedPlayers.length > 0) {
                        this.mergeAndSaveCloudDataset(parsedPlayers);
        ...
        // 2. Dedicated endpoint fallback (if deployed on Render)
        try {
    ...
    async openLeaderboardModal(activeCategory = 'overall') {
        ...
        // 3. Silent 5-Second Live Background Refresh while modal is open
    ...
    getTierTitleAndAvatar(rankNum) {
        if (rankNum === 1) {
            return { title: 'Kozmik Hükümdar', avatar: '1', cssClass: 'top-1' };
        } else if (rankNum === 2) {
            return { title: 'Gümüş Muhafız', avatar: '2', cssClass: 'top-2' };
        } else if (rankNum === 3) {
            return { title: 'Bronz Gladyatör', avatar: '3', cssClass: 'top-3' };
        } else if (rankNum >= 4 && rankNum <= 10) {
            return { title: 'Elit Elmas Usta', avatar: String(rankNum), cssClass: 'top-10' };
        } else if (rankNum >= 11 && rankNum <= 50) {
            return { title: 'Ametist Şampiyon', avatar: String(rankNum), cssClass: 'top-50' };
        } else if (rankNum >= 51 && rankNum <= 100) {
            return { title: 'Parlayan Yıldız', avatar: String(rankNum), cssClass: 'top-100' };
        } else {
            return { title: 'Cesur Savaşçı', avatar: String(rankNum), cssClass: 'top-1000' };
        }
    }
    ...
    async syncCloudLeaderboard() {
        ...
        try {
            ...
            // 1. Immediately update local dataset so the player's own score reflects instantly (0ms)
            this.mergeAndSaveCloudDataset([myEntry]);
    ...
    renderLeaderboardList(category = 'overall') {
        ...
        // Ensure self scores are 100% fresh in dataset before rendering
        this.registerSelfIntoCloudDataset();
        ...
        for (let i = 0; i < displayLimit; i++) {
            ...
            if (player.rank === 1) {
                rankBadgeHtml = `<div class="lb-rank-num rank-1-badge"><span class="rank-digit">1</span></div>`;
                nameTagExtra = `<span class="king-elite-pill">LİDER</span>`;
            } else if (player.rank === 2) {
                rankBadgeHtml = `<div class="lb-rank-num rank-2-badge"><span class="rank-digit">2</span></div>`;
            } else if (player.rank === 3) {
                rankBadgeHtml = `<div class="lb-rank-num rank-3-badge"><span class="rank-digit">3</span></div>`;
            } else if (player.rank <= 10) {
                rankBadgeHtml = `<div class="lb-rank-num rank-10-badge"><span class="rank-digit">${player.rank}</span></div>`;
            }
        ...
        if (selfItem) {
            ...
            if (selfRankBadge) {
                selfRankBadge.innerText = `#${selfItem.rank}`;
            }
