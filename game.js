...
class TileMatchingGame {
    ...
    constructor() {
        ...
        // Vibrant Level Table Themes with Custom Repeating Patterns per Section
        this.bgThemes = [
            'radial-gradient(circle at 50% 35%, #059669 0%, #047857 55%, #064e3b 100%), url("data:image/svg+xml,%3Csvg width=\'40\' height=\'40\' viewBox=\'0 0 40 40\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'%23ffffff\' fill-opacity=\'0.06\'%3E%3Cpath d=\'M0 38L38 0h2v2L2 40H0v-2zm40 0L2 0h-2v2l38 38h2v-2z\'/%3E%3C/g%3E%3C/svg%3E")',
            'radial-gradient(circle at 50% 35%, #2563eb 0%, #1d4ed8 55%, #1e3a8a 100%), url("data:image/svg+xml,%3Csvg width=\'32\' height=\'32\' viewBox=\'0 0 32 32\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M16 0l16 16-16 16L0 16z\' fill=\'%23ffffff\' fill-opacity=\'0.05\'/%3E%3C/svg%3E")',
            'radial-gradient(circle at 50% 35%, #dc2626 0%, #b91c1c 55%, #7f1d1d 100%), url("data:image/svg+xml,%3Csvg width=\'40\' height=\'40\' viewBox=\'0 0 40 40\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M20 0l20 20-20 20L0 20z\' fill=\'%23ffffff\' fill-opacity=\'0.06\'/%3E%3C/svg%3E")',
            'radial-gradient(circle at 50% 35%, #9333ea 0%, #7e22ce 55%, #4c1d95 100%), url("data:image/svg+xml,%3Csvg width=\'36\' height=\'36\' viewBox=\'0 0 36 36\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Ccircle cx=\'18\' cy=\'18\' r=\'12\' stroke=\'%23ffffff\' stroke-width=\'1.5\' fill=\'none\' opacity=\'0.07\'/%3E%3C/svg%3E")',
            'radial-gradient(circle at 50% 35%, #d97706 0%, #b45309 55%, #78350f 100%), url("data:image/svg+xml,%3Csvg width=\'40\' height=\'40\' viewBox=\'0 0 40 40\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 20L20 0l20 20-20 20z\' fill=\'%23ffffff\' fill-opacity=\'0.07\'/%3E%3C/svg%3E")',
            'radial-gradient(circle at 50% 35%, #0891b2 0%, #0e7490 55%, #164e63 100%), url("data:image/svg+xml,%3Csvg width=\'32\' height=\'32\' viewBox=\'0 0 32 32\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 16 Q8 8, 16 16 T32 16\' stroke=\'%23ffffff\' stroke-width=\'2\' fill=\'none\' opacity=\'0.08\'/%3E%3C/svg%3E")',
            'radial-gradient(circle at 50% 35%, #e11d48 0%, #be123c 55%, #881337 100%), url("data:image/svg+xml,%3Csvg width=\'36\' height=\'36\' viewBox=\'0 0 36 36\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M18 0l18 18-18 18L0 18z\' fill=\'%23ffffff\' fill-opacity=\'0.07\'/%3E%3C/svg%3E")',
            'radial-gradient(circle at 50% 35%, #4f46e5 0%, #4338ca 55%, #312e81 100%), url("data:image/svg+xml,%3Csvg width=\'40\' height=\'40\' viewBox=\'0 0 40 40\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Ccircle cx=\'20\' cy=\'20\' r=\'8\' stroke=\'%23ffffff\' stroke-width=\'1.5\' fill=\'none\' opacity=\'0.08\'/%3E%3C/svg%3E")'
        ];
