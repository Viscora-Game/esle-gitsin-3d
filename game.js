...
class TileMatchingGame {
    ...
    constructor() {
        ...
        // Bright, Vibrant Level Table Themes & High-Luminance Arena Backdrops per Section (NO DARK BLACK!)
        this.bgThemes = [
            'url("data:image/svg+xml,%3Csvg width=\'30\' height=\'30\' viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 0h30v30H0z\' fill=\'none\'/%3E%3Cpath d=\'M0 30L30 0h-2L0 28v2zm0-4L26 0h-2L0 24v2zm0-4L22 0h-2L0 20v2zm0-4L18 0h-2L0 16v2zm0-4L14 0h-2L0 12v2zm0-4L10 0H8L0 8v2zm0-4L6 0H4L0 4v2z\' fill=\'%23ffffff\' fill-opacity=\'0.08\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 40%, #10b981 0%, #059669 45%, #047857 75%, #065f46 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M12 0l12 12-12 12L0 12z\' fill=\'%23ffffff\' fill-opacity=\'0.07\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 40%, #60a5fa 0%, #3b82f6 45%, #1d4ed8 75%, #1e40af 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'30\' height=\'30\' viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M15 0l15 15-15 15L0 15z\' fill=\'%23ffffff\' fill-opacity=\'0.08\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 40%, #f43f5e 0%, #e11d48 45%, #be123c 75%, #9f1239 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'28\' height=\'28\' viewBox=\'0 0 28 28\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Ccircle cx=\'14\' cy=\'14\' r=\'8\' stroke=\'%23ffffff\' stroke-width=\'1\' fill=\'none\' opacity=\'0.08\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 40%, #c084fc 0%, #a855f7 45%, #7e22ce 75%, #6b21a8 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'30\' height=\'30\' viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 15L15 0l15 15-15 15z\' fill=\'%23ffffff\' fill-opacity=\'0.08\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 40%, #fbbf24 0%, #f59e0b 45%, #d97706 75%, #92400e 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 12 Q6 6, 12 12 T24 12\' stroke=\'%23ffffff\' stroke-width=\'1.5\' fill=\'none\' opacity=\'0.08\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 40%, #38bdf8 0%, #06b6d4 45%, #0e7490 75%, #155e75 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'28\' height=\'28\' viewBox=\'0 0 28 28\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M14 0l14 14-14 14L0 14z\' fill=\'%23ffffff\' fill-opacity=\'0.08\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 40%, #f472b6 0%, #ec4899 45%, #be185d 75%, #9d174d 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'30\' height=\'30\' viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Ccircle cx=\'15\' cy=\'15\' r=\'6\' stroke=\'%23ffffff\' stroke-width=\'1.2\' fill=\'none\' opacity=\'0.08\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 40%, #818cf8 0%, #6366f1 45%, #4338ca 75%, #3730a3 100%)'
        ];
