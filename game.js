...
class TileMatchingGame {
    ...
    constructor() {
        ...
        // Vibrant Level Table Themes & Rich Ambient Stage Backdrops per Section
        this.bgThemes = [
            'url("data:image/svg+xml,%3Csvg width=\'30\' height=\'30\' viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 0h30v30H0z\' fill=\'none\'/%3E%3Cpath d=\'M0 30L30 0h-2L0 28v2zm0-4L26 0h-2L0 24v2zm0-4L22 0h-2L0 20v2zm0-4L18 0h-2L0 16v2zm0-4L14 0h-2L0 12v2zm0-4L10 0H8L0 8v2zm0-4L6 0H4L0 4v2z\' fill=\'%23ffffff\' fill-opacity=\'0.045\'/%3E%3C/svg%3E"), radial-gradient(ellipse at 50% 40%, #047857 0%, #064e3b 45%, #022c22 85%, #011a14 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M12 0l12 12-12 12L0 12z\' fill=\'%23ffffff\' fill-opacity=\'0.04\'/%3E%3C/svg%3E"), radial-gradient(ellipse at 50% 40%, #1d4ed8 0%, #1e3a8a 45%, #0f172a 85%, #0a0f1d 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'30\' height=\'30\' viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M15 0l15 15-15 15L0 15z\' fill=\'%23ffffff\' fill-opacity=\'0.045\'/%3E%3C/svg%3E"), radial-gradient(ellipse at 50% 40%, #be123c 0%, #881337 45%, #4c0519 85%, #28020d 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'28\' height=\'28\' viewBox=\'0 0 28 28\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Ccircle cx=\'14\' cy=\'14\' r=\'8\' stroke=\'%23ffffff\' stroke-width=\'1\' fill=\'none\' opacity=\'0.04\'/%3E%3C/svg%3E"), radial-gradient(ellipse at 50% 40%, #7e22ce 0%, #581c87 45%, #2e1065 85%, #170736 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'30\' height=\'30\' viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 15L15 0l15 15-15 15z\' fill=\'%23ffffff\' fill-opacity=\'0.045\'/%3E%3C/svg%3E"), radial-gradient(ellipse at 50% 40%, #b45309 0%, #78350f 45%, #451a03 85%, #220c01 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 12 Q6 6, 12 12 T24 12\' stroke=\'%23ffffff\' stroke-width=\'1.5\' fill=\'none\' opacity=\'0.045\'/%3E%3C/svg%3E"), radial-gradient(ellipse at 50% 40%, #0e7490 0%, #155e75 45%, #083344 85%, #031720 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'28\' height=\'28\' viewBox=\'0 0 28 28\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M14 0l14 14-14 14L0 14z\' fill=\'%23ffffff\' fill-opacity=\'0.045\'/%3E%3C/svg%3E"), radial-gradient(ellipse at 50% 40%, #be185d 0%, #831843 45%, #500724 85%, #2a0312 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'30\' height=\'30\' viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Ccircle cx=\'15\' cy=\'15\' r=\'6\' stroke=\'%23ffffff\' stroke-width=\'1.2\' fill=\'none\' opacity=\'0.045\'/%3E%3C/svg%3E"), radial-gradient(ellipse at 50% 40%, #4338ca 0%, #312e81 45%, #1e1b4b 85%, #0c0a27 100%)'
        ];
