...
class TileMatchingGame {
    ...
    constructor() {
        ...
        // Sleek, Eye-Pleasing & Luxurious Level Table Themes (Soft Micro-Felt & Velvet Textures)
        this.bgThemes = [
            'url("data:image/svg+xml,%3Csvg width=\'30\' height=\'30\' viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 0h30v30H0z\' fill=\'none\'/%3E%3Cpath d=\'M0 30L30 0h-2L0 28v2zm0-4L26 0h-2L0 24v2zm0-4L22 0h-2L0 20v2zm0-4L18 0h-2L0 16v2zm0-4L14 0h-2L0 12v2zm0-4L10 0H8L0 8v2zm0-4L6 0H4L0 4v2z\' fill=\'%23ffffff\' fill-opacity=\'0.045\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 35%, #065f46 0%, #047857 60%, #022c22 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M12 0l12 12-12 12L0 12z\' fill=\'%23ffffff\' fill-opacity=\'0.04\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 35%, #1e40af 0%, #1d4ed8 60%, #0f172a 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'30\' height=\'30\' viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M15 0l15 15-15 15L0 15z\' fill=\'%23ffffff\' fill-opacity=\'0.045\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 35%, #9f1239 0%, #be123c 60%, #4c0519 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'28\' height=\'28\' viewBox=\'0 0 28 28\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Ccircle cx=\'14\' cy=\'14\' r=\'8\' stroke=\'%23ffffff\' stroke-width=\'1\' fill=\'none\' opacity=\'0.04\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 35%, #6b21a8 0%, #7e22ce 60%, #2e1065 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'30\' height=\'30\' viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 15L15 0l15 15-15 15z\' fill=\'%23ffffff\' fill-opacity=\'0.045\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 35%, #92400e 0%, #b45309 60%, #451a03 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 12 Q6 6, 12 12 T24 12\' stroke=\'%23ffffff\' stroke-width=\'1.5\' fill=\'none\' opacity=\'0.045\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 35%, #155e75 0%, #0e7490 60%, #083344 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'28\' height=\'28\' viewBox=\'0 0 28 28\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M14 0l14 14-14 14L0 14z\' fill=\'%23ffffff\' fill-opacity=\'0.045\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 35%, #9d174d 0%, #be185d 60%, #500724 100%)',
            'url("data:image/svg+xml,%3Csvg width=\'30\' height=\'30\' viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Ccircle cx=\'15\' cy=\'15\' r=\'6\' stroke=\'%23ffffff\' stroke-width=\'1.2\' fill=\'none\' opacity=\'0.045\'/%3E%3C/svg%3E"), radial-gradient(circle at 50% 35%, #3730a3 0%, #4338ca 60%, #1e1b4b 100%)'
        ];
